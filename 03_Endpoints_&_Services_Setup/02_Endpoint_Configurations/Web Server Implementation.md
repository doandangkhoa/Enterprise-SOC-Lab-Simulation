### 🛠️ Bước 1: Cài đặt "Nền móng" XAMPP
...
4.  Bấm nút **Start** ở 2 dòng đầu tiên là **Apache** và **MySQL**. *(Nếu Windows Firewall có hiện lên hỏi, Khoa nhớ bấm Allow access nhé).* Khi 2 chữ này chuyển sang màu xanh lá cây là thành công!![340ebe5a35237f7b01e2dfdbe47c0f54.png](../../_resources/340ebe5a35237f7b01e2dfdbe47c0f54.png)
    

### 📥 Bước 2: Tải "Bia tập bắn" DVWA
...
### ⚙️ Bước 4: Cấu hình và Kích hoạt
...
3.  Mở file đó lên bằng Notepad. Tìm đến 2 dòng cấu hình Database và sửa lại như sau (để khớp với mật khẩu mặc định của XAMPP):
    ...
    <img src="../../_resources/090e2aae59c20c1d8ceadad7a3462a17.png" alt="090e2aae59c20c1d8ceadad7a3462a17.png" width="496" height="459">
...
5.  Cuộn xuống dưới cùng, bấm vào nút **Create / Reset Database**.
    ...
    - <img src="../../_resources/9b6a0c618db4f1d0046d0efa66f44248.png" alt="9b6a0c618db4f1d0046d0efa66f44248.png" width="664" height="464">
...
- **![365e57aee316d0bca8faab671ae1e229.png](../../_resources/365e57aee316d0bca8faab671ae1e229.png)**